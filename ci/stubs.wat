...
(module
  ...
  (func (export "wasmdoom_sound_is_playing") (param i32) (result i32)
    (i32.const 0))
  (func (export "wasmdoom_music_set_genmidi") (param i32 i32))
  (func (export "wasmdoom_music_register")    (param i32 i32 i32))
  (func (export "wasmdoom_music_play")        (param i32 i32))
  (func (export "wasmdoom_music_pause")       (param i32))
  (func (export "wasmdoom_music_resume")      (param i32))
  (func (export "wasmdoom_music_stop")        (param i32))
  (func (export "wasmdoom_music_unregister")  (param i32))
  (func (export "wasmdoom_music_set_volume")  (param i32))
)
